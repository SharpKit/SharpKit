...
if ($IsLinux) {
    ...
    if ($args[0] -ne "release") {
        dotnet build cecil/Mono.Cecil.csproj                         -p:Configuration=net_4_0_Release -verbosity:minimal
        msbuild NRefactory/NRefactory.sln                       -p:Configuration=net_4_5_Debug   -verbosity:minimal
        dotnet build corex/src/corex                                                                  -verbosity:minimal
        ...
        dotnet build corex/src/corex                                 -p:Configuration=Release         -p:DebugSymbols=false -p:DebugType=None -verbosity:minimal
    ...
    if ($args[0] -ne "release") {
        ...
        dotnet msbuild corex/src/corex                                                                  -verbosity:minimal
        ...
        dotnet msbuild corex/src/corex                                 -p:Configuration=Release         -p:DebugSymbols=false -p:DebugType=None -verbosity:minimal
